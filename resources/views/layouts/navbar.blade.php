    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="mr-2 d-none d-lg-inline text-gray-600 small">
          <!-- Auth() : sebuah fasilitas yang digunakan untuk mengakses informasi tentang pengguna yang saat ini sedang masuk (authenticated) ke dalam sistem -->
          <!-- user() : Ini adalah metode yang digunakan untuk mengakses objek pengguna (user object) yang saat ini sedang masuk. Dalam konteks Laravel, metode ini akan mengembalikan objek yang berisi informasi tentang pengguna yang telah diautentikasi-->
          <!-- name() : digunakan untuk mengambil nilai dari atribut "name" dari objek pengguna tersebut. -->
          {{ auth()->user()->name }}
          <br>
